...
flowchart TD
    ...
    D --> E["WhatsApp Engine Transmission\nDelivery Pacing Applied"]
...
For example, a Standard workspace (or active 7-Day Trial workspace) with a 10,000-message allowance that sends 200 direct messages and 300 group messages has used 500 quota units, leaving 9,500 units for the rest of the period.
