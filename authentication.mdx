...
- **Free Tier**: Free includes 500 Dashboard messages per month. Developer API access requires Standard or higher. Workspaces on the Free plan do not include the `api_access` entitlement.
